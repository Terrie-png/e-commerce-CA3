...
export default class BuyProduct extends Component
{
    ...
    {
        // The user pressed the Paypal checkout popup window confirm button
        // axios.defaults.withCredentials = true
        console.log(paymentData)
        axios.post(`${SERVER_HOST}/sales/${paymentData.orderID}/${this.props.price}`,{data:this.props.product} ,{headers:{"authorization":localStorage.token}})
            .then(res =>
            {
